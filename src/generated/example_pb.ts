...
// @generated from file example.proto (package dev.restate.Greeter, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message dev.restate.Greeter.GreetRequest
 */
export class GreetRequest extends Message<GreetRequest> {
  ...
  static readonly typeName = "dev.restate.Greeter.GreetRequest";
...
/**
 * @generated from message dev.restate.Greeter.GreetResponse
 */
export class GreetResponse extends Message<GreetResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "dev.restate.Greeter.GreetResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
