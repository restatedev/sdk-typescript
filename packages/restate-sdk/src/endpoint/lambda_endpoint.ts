...
import { ServiceBundle } from "../public_api";
import type {
  ServiceDefinition,
...
export class LambdaEndpoint implements LambdaEndpoint {
  ...
  public bindBundle(services: ServiceBundle): LambdaEndpoint {
